 ...
 * Represents an object containing integration data related to NMR spectroscopy.
 */
interface IntegrationObject {
  /** The title of the integration concept */
  title: string;
...
/**
 * @typedef {IntegrationObject[]} IntegrationType
 * Defines an array of integration data objects.
 */
type IntegrationType = IntegrationObject[];

/**
 * @constant {IntegrationType} IntegrationData
 * Stores information about integration in NMR spectroscopy, explaining how the area under peaks relates to the number of hydrogens in a molecule.
 * The descriptions contain interactive HTML elements and references to spectral examples like Ethanol and Diethyl ether.
 */
export const IntegrationData: IntegrationType = [
  {
    ...
    description: `
      ...
      <p>This is where information about the chemical structure of the compound (or at least knowing the formula) becomes extremely handy; but even without knowing the chemical formula, integration is a fundamental piece of information provided in a ¹H NMR spectrum.</p>
    `,
  },
];
