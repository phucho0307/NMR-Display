...
/**
 * @typedef {SymmetryObject[]} SymmetryType
 * Defines an array of symmetry data objects.
 */
type SymmetryType = SymmetryObject[];

/**
 * @constant {SymmetryType} SymmetryData
 ...
 */
export const SymmetryData: SymmetryType = [
  {
    title: "Symmetry",
    description: `
      ...
      <p><button id="component-btn" data-id="11" class="underline inline text-[#A5C882]">Because all three chemical environments are different,</button> there is no symmetry.</p>
      ...
      <p class="flex gap-[130px] w-full items-center justify-center">Symmetry!</p>
    `,
  },
];
