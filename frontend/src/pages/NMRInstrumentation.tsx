  ...
  return (
    <main className="bg-[#0C0C31] w-full h-[922px] flex flex-col p-8">
      <div className="flex">
        ...
        <div className="top-[160px] text-[34px] text-[#FEFCFC] p-8 w-[995px]">
          <p className="font-serif h-[760px] overflow-y-auto">
          ...
          <div className="flex items-center justify-start text-[#A5C882] text-[30px] font-bold z-[1000000px] bottom-8 left-34">
